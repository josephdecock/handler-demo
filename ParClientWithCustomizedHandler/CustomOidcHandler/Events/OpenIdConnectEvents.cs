...
public class OpenIdConnectEvents : RemoteAuthenticationEvents
{
    ...
    public Func<StateDataFormattedContext, Task> OnStateDataFormatted { get; set; } = context => Task.CompletedTask;
    ...
    public virtual Task StateDataFormatted(StateDataFormattedContext context) => OnStateDataFormatted(context);
